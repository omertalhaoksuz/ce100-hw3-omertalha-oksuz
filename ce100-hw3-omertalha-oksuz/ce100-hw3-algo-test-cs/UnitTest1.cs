...
namespace ce100_hw3_algo_test_cs
{
    ...
    {
        [TestMethod]
        public void LongestCommonSubsequence_TestMethod1()
        {
            ...
            int m = s1.Length;
            int n = s2.Length;
            string result = Class1.LongestCommonSubsequence(s1, s2, m, n);
        ...
        [TestMethod]
        public void LongestCommonSubsequence_TestMethod2()
        {
        ...
        [TestMethod]
        public void LongestCommonSubsequence_TestMethod3()
        {
            string s1 = "TASFHAJSF";
